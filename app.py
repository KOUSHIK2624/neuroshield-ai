...
# 🔥 ULTIMATE CONFIG
st.set_page_config(page_title="🛡️ NeuroShield AI", layout="wide", page_icon="🛡️")
...
<div style='text-align:center;padding:3rem;'>
    ...
    <h2 style='color:#00ff88;font-size:3rem;font-family:Orbitron'>Real-time AI Poisoning Detection </h2>
...
<div style='text-align:center;padding:4rem;background:rgba(0,255,255,0.1);border-radius:30px;border:2px solid #00ffff;margin-top:3rem'>
    ...
    <p>👨‍💻[ TEAM NOVA] | 🛡️ Production Ready Security</p>
</div>
""", unsafe_allow_html=True)